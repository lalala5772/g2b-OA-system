      ...
      <div className="mt-10 grid gap-6 md:grid-cols-[280px_1fr]">
        <section className="rounded-lg border border-hairline bg-navy-900 p-6">
          ...
          <button
            ...
            disabled={isScanning}
            className="btn-premium mt-8 w-full rounded-full border border-hairline py-2.5 text-sm tracking-wide text-offwhite hover:border-accent hover:text-accent disabled:opacity-50"
          >
